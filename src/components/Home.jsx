  ...
  return (
    <div>
        <div className='homeSection p-15 pr-5 pt-35 pb-40 flex justify-around flex-wrap bg-gradient-to-b from-blue-200  to-white min-h-screen bg-fixed gap-3'>
            ...
            <button className='border-2 py-1 px-4 border-purple-500  rounded text-lg  cursor-pointer hover:scale-103 hover:border-2  hover:border-green-500 transition-all duration-300 ease-in hover-2'>Watch Demo</button>
            </div>
